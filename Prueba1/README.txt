...
Para lanzar la HMI abrir el archivo "Index.html" en cualquier explorador

Para comenzar a leer datos del arduino es necesario empezar un server local con p5serial

Para correr p5serial hay que instalar npm, corriendo "npm install" desde la terminal,
 una vez instalado ir a la caprte que dice "startSever" y correr "node startserver.js"

Aqui copiare el README file de p5serial por si quedan dudas:
